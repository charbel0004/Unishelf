...
namespace Unishelf.Server.Migrations
{
    ...
    [Migration("20250517152049_Add_DeliveryAdress")]
    partial class Add_DeliveryAdress
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Unishelf.Server.Models.DeliveryAddress", b =>
                {
            ...
            modelBuilder.Entity("Unishelf.Server.Models.DeliveryAddress", b =>
                {
                    b.HasOne("Unishelf.Server.Models.Order", "Order")
                        ...
                        .HasForeignKey("Unishelf.Server.Models.DeliveryAddress", "OrderID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
